      ...
      <div className=" container-wrapper">
        <div className="relative">
          ...
          <div className=" absolute left-0 right-0 top-8 sm:top-[18%]">
            ...
            Bonked Glitch The Heartbeat of Solana's Meme Community
            </h1>
            <p className=" max-w-4xl mx-auto text-center mt-[2%] mb-[3%] text-xs sm:text-xl font-bold">
            Bonked Glitch is more than just a digital currency; it's a revolution in the Solana ecosystem. Aimed at becoming the premier community coin of Web3, Bonked 420 is setting new standards for integration and utility across 
            </p>
